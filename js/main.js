...
$(document).ready(function () {
  ...
  $("#forOffice, #forCar, #about, #price, #contacts").mouseenter(function (
    event
  ) {
    $(".header__forHouse").removeClass("show");
  });
  ...
  $("#forHouse, #forCar, #about, #price, #contacts").mouseenter(function (
    event
  ) {
    $(".header__forOffice").removeClass("show");
  });
  ...
  $("#forHouse, #forOffice, #about, #price, #contacts").mouseenter(function (
    event
  ) {
    $(".header__forCar").removeClass("show");
  });
  ...
  $("#forHouse, #forOffice, #forCar, #price, #contacts").mouseenter(function (
    event
  ) {
    $(".header__about").removeClass("show");
  });
  ...
  $(".header__burger").click(function (event) {
    ...
    $(
      ".header__forHouse, .header__forOffice, .header__forCar, .header__about, .header__menuMobile, .header__menuItem"
    ).removeClass("active");
    $(
      ".header__forHouse, .header__forOffice, .header__forCar, .header__about"
    ).removeClass("show");
  ...
  if ($(window).width() < 576) {
    ...
    $(".header__mobileBack").click(function (event) {
      $(".forApartmentList, .forHouseList, .additionalList").removeClass(
        "active"
      );
    });
  }
